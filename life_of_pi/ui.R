    ...
    fluidRow(
      ...
      column(
        ...
        tagList(
          ...
          tags$img(src = "noc.png", width = "60px", height = "67px"),
          ...
          tags$img(src = "piccc.jpg", width = "250px", height = "250px")
        )
      )
    ),
  ...
  navbarPage(
    ...
    title = tagList(
      fluidRow(
        ...
        div("BY supreeth and ripal", HTML("&nbsp;"),
            tags$a(href = "https://github.com/Supreeth-M", tags$img(src = "GitHub-Mark-Light-120px-plus.png", width = "26px", height = "26px")),
            tags$a(href = "https://github.com/godhaniripal/godhaniripal", tags$img(src = "LI-In-Bug.png", width = "30px", height = "26px")),
    ...
    tabPanel(
      ...
      fluidRow(
        column(
          ...
          br(),
          br(),
          tags$a(href = "https://github.com/godhaniripal/godhaniripal", img(src = "life_of_pi_hex.png", width = "100px", height = "110px", style = "position: absolute; top: 200px; left:10px;"))
        ...
        column(
          ...
          p("This app is developed and designed by Supreeth and Ripal under the supervision of Santosh Sir.,
          It is designed to run a Monte Carlo Simulation to estimate the value of π (Pi).,
            I'm sorry to disappoint some of you who might have thought it had something to 
            do with the movie. But I can share a bit of history though.."),
          p("Pi wasn’t always known as pi. Before the 1700s,
            ...
            a friend of Sir Isaac Newton (my student), began using the symbol for \\(\\pi\\) in 1706."),
          # 
